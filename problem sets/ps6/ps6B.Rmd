...
#Because this code yields 0 rows, we know there are 0 instances of tweets by screen names other than realDonaldTrump. 
...
> ANSWER: 5 different sources are used, including an ipad, android, and iphone. The iphone was used 628 times, the android 762 times, the ipad once, a fourth source 120 times, and fifth source 1 time.  
...
> ANSWER: The extract function pulls out the rows in which statusSource indicates an android or iphone was used. 
...
#Adding two new stop words
data(stop_words)
newstopwords = c("https", "")
newstopwords2 = c("t.co", "")
stopwords <- rbind(stop_words, newstopwords, newstopwords2)
